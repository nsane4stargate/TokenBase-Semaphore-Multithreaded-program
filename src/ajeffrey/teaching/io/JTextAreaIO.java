...
public interface JTextAreaIO {
     ...
     */
    OutputStream buildOutputStream(JTextArea ta);
     ...
     */
    PrintStream buildPrintStream(JTextArea ta);
     ...
     */
    Writer buildWriter(JTextArea ta);
     ...
     */
    PrintWriter buildPrintWriter(JTextArea ta);

    /**
     * A factory object for building all these IO streams.
     */
    JTextAreaIO singleton = new JTextAreaIOImpl ();
